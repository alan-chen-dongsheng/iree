module {
  ...
  util.global private mutable @SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer
  util.initializer {
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %allocator = hal.device.allocator<%device : !hal.device> : !hal.allocator
    %memory_type = hal.memory_type<"DeviceVisible|DeviceLocal"> : i32
    %buffer_usage = hal.buffer_usage<"TransferSource|TransferTarget|Transfer|DispatchStorageRead|DispatchStorageWrite|DispatchStorage"> : i32
    %c10937344 = arith.constant 10937344 : index
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%queue_affinity) type(%memory_type) usage(%buffer_usage) : !hal.buffer{%c10937344}
    util.global.store %buffer, @SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer
    util.return
  }
  util.func public @SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer = util.global.load @SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    %c3000000 = arith.constant 3000000 : index
    %c3000064 = arith.constant 3000064 : index
    %c896 = arith.constant 896 : index
    %c3001088 = arith.constant 3001088 : index
    %c7936128 = arith.constant 7936128 : index
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@SingleConv$async_dispatch_0::@embedded_elf_x86_64::@SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@SingleConv$async_dispatch_0) : !hal.executable
    ...
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer)[%c0, %c3000000], 
        (%SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer)[%c3000064, %c896], 
        (%SingleConv$async_dispatch_0_embedded_elf_x86_64_SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32_buffer : !hal.buffer)[%c3001088, %c7936128]
      ]) flags("None")
