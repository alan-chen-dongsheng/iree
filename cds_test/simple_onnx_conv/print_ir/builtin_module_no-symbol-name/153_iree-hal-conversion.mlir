...
module {
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %0 = hal.device.memoize<%__device_0_1 : !hal.device> affinity(%c-1_i64_2) -> !hal.command_buffer {
      ...
      %exe = hal.executable.lookup device(%1 : !hal.device) executable(@SingleConv$async_dispatch_0) : !hal.executable
      ...
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%c6889, %c1_10, %c1_11]) bindings([
        (%c0_3 : index)[%c0, %c3000000], 
        (%__constant_tensor_8x3x3x3xf32 : !hal.buffer)[%c0, %c896], 
        (%c1_4 : index)[%c0, %c7936128]
      ]) flags("None")
