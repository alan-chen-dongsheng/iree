...
func.func @SingleConv(%arg0: !torch.vtensor<[1,3,500,500],f32>) -> !torch.vtensor<[1,8,498,498],f32> attributes {torch.onnx_meta.ir_version = 13 : si64, torch.onnx_meta.opset_version = 25 : si64, torch.onnx_meta.producer_name = "single_conv_example", torch.onnx_meta.producer_version = ""} {
  ...
  %4 = torch.shape.calculate {
    %5 = torch.aten.convolution %arg0, %0, %1, %3, %2, %3, %false, %2, %int1 : !torch.vtensor<[1,3,500,500],f32>, !torch.vtensor<[8,3,3,3],f32>, !torch.vtensor<[8],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int -> !torch.vtensor<[1,8,498,498],f32>
    torch.shape.calculate.yield %5 : !torch.vtensor<[1,8,498,498],f32>
  } shapes {
    %5 = torch.prim.ListConstruct %int1, %int3, %int500, %int500 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %6 = torch.prim.ListConstruct %int8, %int3, %int3, %int3 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>
    %7 = torch.prim.ListConstruct  : () -> !torch.list<int>
    %8 = torch.aten.append.t %7, %int1 : !torch.list<int>, !torch.int -> !torch.list<int>
    %9 = torch.aten.append.t %7, %int8 : !torch.list<int>, !torch.int -> !torch.list<int>
  ...
  return %4 : !torch.vtensor<[1,8,498,498],f32>
}
