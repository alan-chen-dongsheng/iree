    ...
    scf.for %arg1 = %c0 to %c6 step %c1 {
      ...
      scf.for %arg2 = %c0 to %c3 step %c1 {
        scf.for %arg3 = %c0 to %c3 step %c1 {
          ...
          %subview_9 = memref.subview %assume_align_2[%arg0, %arg2, %arg3, 0] [1, 1, 1, 3] [1, 1, 1, 1] : memref<8x3x3x3xf32> to memref<1x1x1x3xf32, strided<[27, 9, 3, 1], offset: ?>>
          %subview_10 = memref.subview %assume_align[%arg2, %16, %10] [1, 1, 8] [1, 1, 1] : memref<3x500x500xf32> to memref<1x1x8xf32, strided<[250000, 500, 1], offset: ?>>
          linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3, d4, d5) -> (d3, d1 + d4, d2 + d5)>, affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d3, d4, d5)>, affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%subview_10, %subview_9 : memref<1x1x8xf32, strided<[250000, 500, 1], offset: ?>>, memref<1x1x1x3xf32, strided<[27, 9, 3, 1], offset: ?>>) outs(%alloca : memref<1x1x6xf32>) {
