...
func.func @SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert>} {
  ...
  %7 = scf.forall (%arg0, %arg1) = (0, 0) to (498, 498) step (6, 6) shared_outs(%arg2 = %6) -> (tensor<8x498x498xf32>) {
    ...
    %8 = bufferization.alloc_tensor() : tensor<1x1x6xf32>
    %9 = vector.transfer_write %cst, %8[%c0, %c0, %c0] {in_bounds = [true, true, true]} : vector<1x1x6xf32>, tensor<1x1x6xf32>
    %10 = scf.for %arg3 = %c0 to %c8 step %c1 iter_args(%arg4 = %extracted_slice) -> (tensor<8x6x6xf32>) {
      %11 = vector.transfer_read %cst_0[%arg3], %0 {in_bounds = [true]} : tensor<8xf32>, vector<1xf32>
      %12 = vector.broadcast %11 : vector<1xf32> to vector<1x1x6xf32>
      %13 = scf.for %arg5 = %c0 to %c6 step %c1 iter_args(%arg6 = %arg4) -> (tensor<8x6x6xf32>) {
        %14 = scf.for %arg7 = %c0 to %c3 step %c1 iter_args(%arg8 = %9) -> (tensor<1x1x6xf32>) {
          %18 = scf.for %arg9 = %c0 to %c3 step %c1 iter_args(%arg10 = %arg8) -> (tensor<1x1x6xf32>) {
            %19 = affine.apply affine_map<()[s0, s1, s2] -> (s0 + s1 + s2)>()[%arg9, %arg5, %arg0]
            %extracted_slice_1 = tensor.extract_slice %5[%arg3, %arg7, %arg9, 0] [1, 1, 1, 3] [1, 1, 1, 1] : tensor<8x3x3x3xf32> to tensor<1x1x1x3xf32>
            %extracted_slice_2 = tensor.extract_slice %4[%arg7, %19, %arg1] [1, 1, 8] [1, 1, 1] : tensor<3x500x500xf32> to tensor<1x1x8xf32>
            ...
            ^bb0(%in: f32, %in_3: f32, %out: f32):
              %21 = arith.mulf %in, %in_3 : f32
              %22 = arith.addf %out, %21 : f32
              linalg.yield %22 : f32
            } -> tensor<1x1x6xf32>
            scf.yield %20 : tensor<1x1x6xf32>
          }
          scf.yield %18 : tensor<1x1x6xf32>
        }
        %15 = vector.transfer_read %14[%c0, %c0, %c0], %0 {in_bounds = [true, true, true]} : tensor<1x1x6xf32>, vector<1x1x6xf32>
        %16 = arith.addf %15, %12 : vector<1x1x6xf32>
        %17 = vector.transfer_write %16, %arg6[%arg3, %arg5, %c0] {in_bounds = [true, true, true]} : vector<1x1x6xf32>, tensor<8x6x6xf32>
        scf.yield %17 : tensor<8x6x6xf32>
      }
      scf.yield %13 : tensor<8x6x6xf32>
    }
