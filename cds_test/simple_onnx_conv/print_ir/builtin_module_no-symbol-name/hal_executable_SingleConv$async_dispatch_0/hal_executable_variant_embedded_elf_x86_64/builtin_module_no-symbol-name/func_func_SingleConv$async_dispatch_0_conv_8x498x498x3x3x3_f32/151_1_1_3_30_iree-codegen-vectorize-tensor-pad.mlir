...
func.func @SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32() attributes {translation_info = #iree_codegen.translation_info<pipeline = CPUDoubleTilingExpert>} {
  ...
  %6 = scf.forall (%arg0, %arg1) = (0, 0) to (498, 498) step (6, 6) shared_outs(%arg2 = %5) -> (tensor<8x498x498xf32>) {
    ...
    %7 = scf.for %arg3 = %c0 to %c8 step %c1 iter_args(%arg4 = %extracted_slice) -> (tensor<8x6x6xf32>) {
      %8 = scf.for %arg5 = %c0 to %c6 step %c1 iter_args(%arg6 = %arg4) -> (tensor<8x6x6xf32>) {
        ...
        %11 = scf.for %arg7 = %c0 to %c3 step %c1 iter_args(%arg8 = %10) -> (tensor<1x1x6xf32>) {
          %13 = scf.for %arg9 = %c0 to %c3 step %c1 iter_args(%arg10 = %arg8) -> (tensor<1x1x6xf32>) {
            ...
            %extracted_slice_3 = tensor.extract_slice %3[%arg7, %14, %arg1] [1, 1, 8] [1, 1, 1] : tensor<3x500x500xf32> to tensor<1x1x8xf32>
            %extracted_slice_4 = tensor.extract_slice %4[%arg3, %arg7, %arg9, 0] [1, 1, 1, 3] [1, 1, 1, 1] : tensor<8x3x3x3xf32> to tensor<1x1x1x3xf32>
        ...
        %12 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1, d2)>, affine_map<(d0, d1, d2) -> (d0)>, affine_map<(d0, d1, d2) -> (d0, d1, d2)>], iterator_types = ["parallel", "parallel", "parallel"]} ins(%11, %extracted_slice_1 : tensor<1x1x6xf32>, tensor<1xf32>) outs(%extracted_slice_2 : tensor<1x1x6xf32>) attrs =  {lowering_config = #iree_cpu.lowering_config<vector_common_parallel = [1, 1, 8]>} {
