      ...
      scf.for %arg3 = %c0 to %c6 step %c1 {
        ...
        scf.for %arg4 = %c0 to %c3 step %c1 {
          scf.for %arg5 = %c0 to %c3 step %c1 {
            ...
            %subview_7 = memref.subview %assume_align[%arg4, %9, %arg1] [1, 1, 8] [1, 1, 1] : memref<3x500x500xf32, #hal.descriptor_type<storage_buffer>> to memref<1x1x8xf32, strided<[250000, 500, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
        ...
        %6 = vector.transfer_read %subview_5[%c0], %0 {in_bounds = [true]} : memref<6xf32, strided<[1]>>, vector<6xf32>
        %7 = vector.broadcast %5 : vector<1xf32> to vector<6xf32>
        %8 = arith.addf %6, %7 : vector<6xf32>
        vector.transfer_write %8, %subview[%arg2, %arg3, %c0] {in_bounds = [true]} : vector<6xf32>, memref<8x6x6xf32, strided<[248004, 498, 1], offset: ?>, #hal.descriptor_type<storage_buffer>>
      }
    }
