      ...
      scf.for %arg2 = %c0 to %c1 step %c1 {
        scf.for %arg3 = %c0 to %c1 step %c1 {
          scf.for %arg4 = %c0 to %c6 step %c1 {
            %15 = memref.load %alloca_1[%arg2, %arg3, %arg4] : memref<1x1x6xf32>
            memref.store %15, %alloca[%arg2, %arg3, %arg4] : memref<1x1x6xf32>
          }
        }
      }
                ...
                scf.for %arg7 = %c0 to %c1 step %c1 {
                  scf.for %arg8 = %c0 to %c1 step %c1 {
                    scf.for %arg9 = %c0 to %c3 step %c1 {
                      %17 = affine.apply affine_map<(d0, d1) -> (d0 + d1)>(%arg5, %arg8)
                      %18 = affine.apply affine_map<(d0, d1) -> (d0 + d1)>(%arg6, %arg9)
                      %19 = memref.load %subview_7[%arg7, %17, %18] : memref<1x1x8xf32, strided<[250000, 500, 1], offset: ?>>
                      %20 = memref.load %subview_6[%arg4, %arg7, %arg8, %arg9] : memref<1x1x1x3xf32, strided<[27, 9, 3, 1], offset: ?>>
                      %21 = memref.load %alloca[%arg4, %arg5, %arg6] : memref<1x1x6xf32>
                      %22 = arith.mulf %19, %20 : f32
                      %23 = arith.addf %21, %22 : f32
                      memref.store %23, %alloca[%arg4, %arg5, %arg6] : memref<1x1x6xf32>
                    }
                  }
                }
              }
