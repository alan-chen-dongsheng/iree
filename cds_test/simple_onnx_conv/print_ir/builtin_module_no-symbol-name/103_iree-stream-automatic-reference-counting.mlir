...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.initializer {
    ...
    %1:2 = scf.if %did_map -> (!stream.timepoint, !stream.resource<constant>) {
      ...
      %3 = stream.resource.alloc uninitialized on(#hal.device.affinity<@__device_0>) : !stream.resource<constant>{%c896}
      %file = stream.file.constant on(#hal.device.affinity<@__device_0>) %buffer_cst[%c0 for %c896] : !util.buffer{%c896} -> !stream.file
      %4 = stream.file.read on(#hal.device.affinity<@__device_0>) await(%0) => %file[%c0_i64], %3[%c0], %c896 : !stream.file -> !stream.resource<constant>{%c896} => !stream.timepoint
      scf.yield %4, %3 : !stream.timepoint, !stream.resource<constant>
    }
    %2 = stream.timepoint.await sync %1#0 => %1#1 : !stream.resource<constant>{%c896}
    util.global.store %2, @__constant_tensor_8x3x3x3xf32 : !stream.resource<constant>
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %3 = stream.timepoint.join max(%1, %__constant_tensor_8x3x3x3xf32__timepoint, %result_timepoint) => !stream.timepoint
    %4 = stream.cmd.execute on(#hal.device.affinity<@__device_0>) await(%3) => with(%0 as %arg3: !stream.resource<external>{%c3000000}, %__constant_tensor_8x3x3x3xf32 as %arg4: !stream.resource<constant>{%c896}, %result as %arg5: !stream.resource<external>{%c7936128}) {
