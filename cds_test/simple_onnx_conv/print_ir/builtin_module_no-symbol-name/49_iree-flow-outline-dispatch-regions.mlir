...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  flow.executable private @SingleConv$async_dispatch_0 {
    flow.executable.export public @SingleConv$async_dispatch_0 workgroups() -> (index, index, index) {
      %x, %y, %z = iree_tensor_ext.dispatch.workgroup_count_from_slice()
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @SingleConv$async_dispatch_0(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<3x500x500xf32>>, %arg1: !iree_tensor_ext.dispatch.tensor<readonly:tensor<8x3x3x3xf32>>, %arg2: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8x498x498xf32>>) {
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %2 = flow.dispatch @SingleConv$async_dispatch_0::@SingleConv$async_dispatch_0(%1, %cst) : (tensor<3x500x500xf32>, tensor<8x3x3x3xf32>) -> tensor<8x498x498xf32>
