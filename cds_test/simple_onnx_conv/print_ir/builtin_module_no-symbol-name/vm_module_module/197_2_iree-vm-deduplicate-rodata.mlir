...
vm.module public @module {
  ...
  ^bb6:  // pred: ^bb5
    ...
    vm.br ^bb7
  ^bb7:  // 2 preds: ^bb5, ^bb6
    %_utf8_hal_executable_format_E03EECB63A2AAF52_13 = vm.const.ref.rodata @_utf8_hal_executable_format_E03EECB63A2AAF52 : !vm.buffer
    %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_14 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83 : !vm.buffer
    %16:2 = vm.call @hal.device.query.i64(%4, %_utf8_hal_executable_format_E03EECB63A2AAF52_13, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_14) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
    %nz_15 = vm.cmp.nz.i64 %16#1 : i64
    %zero_16 = vm.const.i32.zero
    %17 = vm.select.i32 %16#0, %nz_15, %zero_16 : i32
    %c1_17 = vm.const.i32 1
    %18 = vm.select.i64 %17, %zero_5, %c-1_2 : i64
    %eq_18 = vm.cmp.eq.i64 %18, %zero_5 : i64
    vm.global.store.ref %4, @__device_0 : !vm.ref<!hal.device>
    vm.cond_br %eq_18, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    ...
    %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_19 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83 : !vm.buffer
    %null_20 = vm.const.ref.zero : !vm.buffer
    %ref_21 = vm.call @hal.executable.create(%4, %c-1_3, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_19, %SingleConv_async_dispatch_0_embedded_elf_x86_64, %null_20) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
  ...
  ^bb10(%19: !vm.ref<!hal.executable>):  // 2 preds: ^bb8, ^bb9
    ...
    %ref_22 = vm.call @hal.device.allocator(%__device_0) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
    %c1_23 = vm.const.i32 1
    %ref_24 = vm.call @hal.allocator.import(%ref_22, %c1_23, %c-1_3, %c48, %c527363, %_const, %zero_5, %c896) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
    ...
    vm.cond_br %rnz, ^bb12(%null, %ref_24 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb11
  ^bb11:  // pred: ^bb10
    %ref_25 = vm.call @hal.allocator.allocate(%ref_22, %c-1_3, %c48, %c527363, %c896) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
    %c1_26 = vm.const.i32 1
    %ref_27 = vm.call @hal.ex.file.from_memory(%__device_0, %c-1_3, %c1_26, %_const, %zero_5, %c896, %zero_0) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
    %zero_28 = vm.const.i64.zero
    %ref_29 = vm.call @hal.fence.create(%__device_0, %zero_28) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
    %zero_30 = vm.const.i64.zero
    vm.call @hal.device.queue.read(%__device_0, %c-1_3, %null, %ref_29, %ref_27, %zero, %ref_25, %zero_5, %c896, %zero_30) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
    vm.br ^bb12(%ref_29, %ref_25 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb12(%20: !vm.ref<!hal.fence>, %21: !vm.ref<!hal.buffer>):  // 2 preds: ^bb10, ^bb11
    %zero_31 = vm.const.i64.zero
    %22 = vm.call.variadic @hal.fence.await(%c-1, %zero_31, [%20]) : (i32, i64, !vm.ref<!hal.fence> ...) -> i32
    vm.cond_fail %22, "failed to wait on timepoint"
    vm.global.store.ref %21, @__constant_tensor_8x3x3x3xf32 : !vm.ref<!hal.buffer>
    %ref_32 = vm.call @__SingleConv$async_memoize_apply() : () -> !vm.ref<!hal.command_buffer>
    vm.global.store.ref %ref_32, @__SingleConv$async_memoize_result_0_device_0 : !vm.ref<!hal.command_buffer>
    vm.return
  }
  ...
  vm.func private @SingleConv$async(%arg0: !vm.ref<!hal.buffer_view>, %arg1: !vm.ref<!hal.fence>, %arg2: !vm.ref<!hal.fence>) -> !vm.ref<!hal.buffer_view> attributes {inlining_policy = #util.inline.never} {
    ...
    vm.call @hal.buffer.assert(%ref, %_utf8_tensor_FC1814BC4A58F22A_3, %ref_2, %c3000000, %c16, %c3075_4) : (!vm.ref<!hal.buffer>, !vm.buffer, !vm.ref<!hal.allocator>, i64, i32, i32) -> ()
    %zero_5 = vm.const.i64.zero
