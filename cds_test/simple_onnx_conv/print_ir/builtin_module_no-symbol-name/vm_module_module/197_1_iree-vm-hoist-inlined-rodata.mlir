...
vm.module public @module {
  ...
  vm.rodata private @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_1 {alignment = 1 : i64} "embedded-elf-x86_64"
  ...
  vm.rodata private @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_2 {alignment = 1 : i64} "embedded-elf-x86_64"
  ...
  ^bb7:  // 2 preds: ^bb5, ^bb6
    ...
    %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_1 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_1 : !vm.buffer
    %16:2 = vm.call @hal.device.query.i64(%4, %_utf8_hal_executable_format_E03EECB63A2AAF52_0, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_1) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
    ...
    %eq_16 = vm.cmp.eq.i64 %18, %zero_5 : i64
  ...
  ^bb8:  // pred: ^bb7
    ...
    %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_2 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_2 : !vm.buffer
    %null_17 = vm.const.ref.zero : !vm.buffer
    %ref_18 = vm.call @hal.executable.create(%4, %c-1_3, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_2, %SingleConv_async_dispatch_0_embedded_elf_x86_64, %null_17) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
    vm.br ^bb10(%ref_18 : !vm.ref<!hal.executable>)
  ^bb9:  // pred: ^bb7
  ...
  ^bb10(%19: !vm.ref<!hal.executable>):  // 2 preds: ^bb8, ^bb9
    ...
    %ref_19 = vm.call @hal.device.allocator(%__device_0) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
    %c1_20 = vm.const.i32 1
    %ref_21 = vm.call @hal.allocator.import(%ref_19, %c1_20, %c-1_3, %c48, %c527363, %_const, %zero_5, %c896) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
    ...
    vm.cond_br %rnz, ^bb12(%null, %ref_21 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb11
  ^bb11:  // pred: ^bb10
    %ref_22 = vm.call @hal.allocator.allocate(%ref_19, %c-1_3, %c48, %c527363, %c896) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
    %c1_23 = vm.const.i32 1
    %ref_24 = vm.call @hal.ex.file.from_memory(%__device_0, %c-1_3, %c1_23, %_const, %zero_5, %c896, %zero_0) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
    %zero_25 = vm.const.i64.zero
    %ref_26 = vm.call @hal.fence.create(%__device_0, %zero_25) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
    %zero_27 = vm.const.i64.zero
    vm.call @hal.device.queue.read(%__device_0, %c-1_3, %null, %ref_26, %ref_24, %zero, %ref_22, %zero_5, %c896, %zero_27) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
    vm.br ^bb12(%ref_26, %ref_22 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
  ^bb12(%20: !vm.ref<!hal.fence>, %21: !vm.ref<!hal.buffer>):  // 2 preds: ^bb10, ^bb11
    %zero_28 = vm.const.i64.zero
    %22 = vm.call.variadic @hal.fence.await(%c-1, %zero_28, [%20]) : (i32, i64, !vm.ref<!hal.fence> ...) -> i32
    vm.cond_fail %22, "failed to wait on timepoint"
    vm.global.store.ref %21, @__constant_tensor_8x3x3x3xf32 : !vm.ref<!hal.buffer>
    %ref_29 = vm.call @__SingleConv$async_memoize_apply() : () -> !vm.ref<!hal.command_buffer>
    vm.global.store.ref %ref_29, @__SingleConv$async_memoize_result_0_device_0 : !vm.ref<!hal.command_buffer>
    vm.return
  }
  ...
  vm.func private @SingleConv$async(%arg0: !vm.ref<!hal.buffer_view>, %arg1: !vm.ref<!hal.fence>, %arg2: !vm.ref<!hal.fence>) -> !vm.ref<!hal.buffer_view> attributes {inlining_policy = #util.inline.never} {
    ...
    vm.call.variadic @hal.buffer_view.assert(%arg0, %_utf8_tensor_FC1814BC4A58F22A, %c553648160, %c1_1, [%c1, %c3, %c500, %c500]) : (!vm.ref<!hal.buffer_view>, !vm.buffer, i32, i32, i64 ...)
    ...
    vm.call @hal.buffer.assert(%ref, %_utf8_tensor_FC1814BC4A58F22A_3, %ref_2, %c3000000, %c16, %c3075_3) : (!vm.ref<!hal.buffer>, !vm.buffer, !vm.ref<!hal.allocator>, i64, i32, i32) -> ()
    ...
    %ref_7 = vm.call @hal.device.queue.alloca(%__device_0, %c-1, %arg1, %ref_5, %zero_0, %c48, %c3075, %c7936128, %zero_6) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, i64, i32, i32, i64, i64) -> !vm.ref<!hal.buffer>
    %zero_8 = vm.const.i64 0
    vm.call.variadic @hal.device.queue.execute.indirect(%__device_0, %c-1, %ref_5, %arg2, %__SingleConv$async_memoize_result_0_device_0, %zero_8, [(%ref, %zero, %c3000000), (%ref_7, %zero, %c7936128)]) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.command_buffer>, i64, tuple<!vm.ref<!hal.buffer>, i64, i64> ...)
    %ref_9 = vm.call.variadic @hal.buffer_view.create(%ref_7, %zero, %c7936128, %c553648160, %c1_1, [%c1, %c8, %c498, %c498]) {nosideeffects} : (!vm.ref<!hal.buffer>, i64, i64, i32, i32, i64 ...) -> !vm.ref<!hal.buffer_view>
