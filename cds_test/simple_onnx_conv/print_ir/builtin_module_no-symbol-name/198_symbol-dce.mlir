...
module attributes {vm.toplevel} {
  vm.module public @module {
    ...
    vm.rodata private @_const {alignment = 64 : i64} #composite_of_896b
    vm.initializer {
      ...
      %c-1 = vm.const.i32 -1
      %null_2 = vm.const.ref.zero : !vm.ref<!hal.executable>
      %c14 = vm.const.i32 14
      %c-1_3 = vm.const.i64 -1
      %c18 = vm.const.i32 18
      %c1_4 = vm.const.i64 1
      %null_5 = vm.const.ref.zero : !vm.ref<!hal.device>
      %0 = vm.call @hal.devices.count() {nosideeffects} : () -> i32
      %1 = vm.ext.i32.i64.s %0 : i32 -> i64
      vm.br ^bb1(%zero, %zero, %null_5 : i64, i64, !vm.ref<!hal.device>)
    ^bb1(%2: i64, %3: i64, %4: !vm.ref<!hal.device>):  // 2 preds: ^bb0, ^bb4
      %req = vm.cmp.eq.ref %4, %null_5 : !vm.ref<!hal.device>
    ...
    ^bb2:  // pred: ^bb1
      ...
      %8 = vm.select.i32 %7#0, %nz, %zero_1 : i32
      vm.cond_br %8, ^bb3, ^bb4(%zero_1 : i32)
    ^bb3:  // pred: ^bb2
      ...
      %nz_6 = vm.cmp.nz.i64 %9#1 : i64
      %10 = vm.select.i32 %9#0, %nz_6, %zero_1 : i32
      vm.br ^bb4(%10 : i32)
    ^bb4(%11: i32):  // 2 preds: ^bb2, ^bb3
      %eq = vm.cmp.eq.i64 %3, %zero : i64
      %12 = vm.select.i64 %11, %c1_4, %zero : i64
      %13 = vm.add.i64 %3, %12 : i64
      %14 = vm.and.i32 %11, %eq : i32
      %ref_7 = vm.select.ref %14, %ref, %null_5 : !vm.ref<!hal.device>
      %15 = vm.add.i64 %2, %c1_4 : i64
    ...
    ^bb6:  // pred: ^bb5
      ...
      vm.br ^bb7
    ^bb7:  // 2 preds: ^bb5, ^bb6
      %_utf8_hal_executable_format_E03EECB63A2AAF52_8 = vm.const.ref.rodata @_utf8_hal_executable_format_E03EECB63A2AAF52 : !vm.buffer
      %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_9 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83 : !vm.buffer
      %16:2 = vm.call @hal.device.query.i64(%4, %_utf8_hal_executable_format_E03EECB63A2AAF52_8, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_9) {nosideeffects} : (!vm.ref<!hal.device>, !vm.buffer, !vm.buffer) -> (i32, i64)
      %nz_10 = vm.cmp.nz.i64 %16#1 : i64
      %17 = vm.select.i32 %16#0, %nz_10, %zero_1 : i32
      %18 = vm.select.i64 %17, %zero, %c-1_3 : i64
      %eq_11 = vm.cmp.eq.i64 %18, %zero : i64
    ...
    ^bb8:  // pred: ^bb7
      ...
      %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_12 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83 : !vm.buffer
      %ref_13 = vm.call @hal.executable.create(%4, %c-1_3, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_12, %SingleConv_async_dispatch_0_embedded_elf_x86_64, %null) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
    ...
    ^bb9:  // pred: ^bb7
      ...
      vm.br ^bb10(%null_2 : !vm.ref<!hal.executable>)
    ^bb10(%19: !vm.ref<!hal.executable>):  // 2 preds: ^bb8, ^bb9
      ...
      %ref_14 = vm.call @hal.device.allocator(%__device_0) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
      %ref_15 = vm.call @hal.allocator.import(%ref_14, %c1, %c-1_3, %c48, %c527363, %_const, %zero, %c896) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
      %rnz = vm.cmp.nz.ref %ref_15 : !vm.ref<!hal.buffer>
      vm.global.store.ref %19, @__device_0_executable_0_SingleConv$async_dispatch_0 : !vm.ref<!hal.executable>
      vm.cond_br %rnz, ^bb12(%null_0, %ref_15 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb11
    ^bb11:  // pred: ^bb10
      %ref_16 = vm.call @hal.allocator.allocate(%ref_14, %c-1_3, %c48, %c527363, %c896) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
      %ref_17 = vm.call @hal.ex.file.from_memory(%__device_0, %c-1_3, %c1, %_const, %zero, %c896, %zero_1) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
      %ref_18 = vm.call @hal.fence.create(%__device_0, %zero) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
      vm.call @hal.device.queue.read(%__device_0, %c-1_3, %null_0, %ref_18, %ref_17, %zero, %ref_16, %zero, %c896, %zero) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
      vm.br ^bb12(%ref_18, %ref_16 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
    ^bb12(%20: !vm.ref<!hal.fence>, %21: !vm.ref<!hal.buffer>):  // 2 preds: ^bb10, ^bb11
      ...
      %ref_19 = vm.call @__SingleConv$async_memoize_apply() : () -> !vm.ref<!hal.command_buffer>
      vm.global.store.ref %ref_19, @__SingleConv$async_memoize_result_0_device_0 : !vm.ref<!hal.command_buffer>
      vm.return
    }
