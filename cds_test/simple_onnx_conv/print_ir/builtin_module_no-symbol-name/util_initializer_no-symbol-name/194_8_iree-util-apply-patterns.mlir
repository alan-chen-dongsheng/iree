...
^bb6:  // pred: ^bb5
  ...
  cf.br ^bb7
^bb7:  // 2 preds: ^bb5, ^bb6
  %ok_2, %value_3 = hal.device.query<%5 : !hal.device> key("hal.executable.format" :: "embedded-elf-x86_64") : i1, i1 = false
  %16 = arith.select %value_3, %c0, %c-1 : index
...
^bb8:  // pred: ^bb7
  %executable = hal.executable.create device(%5 : !hal.device) affinity(%c-1_i64) target(@SingleConv$async_dispatch_0::@embedded_elf_x86_64) : !hal.executable
