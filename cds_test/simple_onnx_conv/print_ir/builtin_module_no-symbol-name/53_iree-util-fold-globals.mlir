...
module attributes {iree.fixedpoint.iteration = 0 : index, stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  flow.executable private @SingleConv$async_dispatch_0 {
    ...
    builtin.module {
      func.func @SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<3x500x500xf32>>, %arg1: !iree_tensor_ext.dispatch.tensor<readonly:tensor<8x3x3x3xf32>>, %arg2: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8x498x498xf32>>) {
        ...
        %4 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "parallel", "reduction", "reduction", "reduction"]} ins(%0, %1 : tensor<3x500x500xf32>, tensor<8x3x3x3xf32>) outs(%3 : tensor<8x498x498xf32>) {
        ^bb0(%in: f32, %in_1: f32, %out: f32):
          %6 = arith.mulf %in, %in_1 : f32
          %7 = arith.addf %out, %6 : f32
          linalg.yield %7 : f32
        } -> tensor<8x498x498xf32>
        %5 = linalg.generic {indexing_maps = [#map3, #map4, #map3], iterator_types = ["parallel", "parallel", "parallel"]} ins(%4, %cst_0 : tensor<8x498x498xf32>, tensor<8xf32>) outs(%2 : tensor<8x498x498xf32>) {
        ^bb0(%in: f32, %in_1: f32, %out: f32):
  ...
  util.global private @__constant_tensor_8x3x3x3xf32 {inlining_policy = #util.inline.never, stream.affinity.default = #hal.device.affinity<@__device_0>} = dense<""> : tensor<8x3x3x3xf32>
