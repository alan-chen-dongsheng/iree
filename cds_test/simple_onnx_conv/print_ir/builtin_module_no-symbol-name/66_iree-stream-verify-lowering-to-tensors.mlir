...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    %__constant_tensor_8x3x3x3xf32 = util.global.load @__constant_tensor_8x3x3x3xf32 : !stream.resource<constant>
    %__constant_tensor_8x3x3x3xf32__size = util.global.load @__constant_tensor_8x3x3x3xf32__size : index
    %0 = stream.async.transfer %__constant_tensor_8x3x3x3xf32 : !stream.resource<constant>{%__constant_tensor_8x3x3x3xf32__size} from(#hal.device.affinity<@__device_0>) -> to(#hal.device.affinity<@__device_0>) !stream.resource<*>{%__constant_tensor_8x3x3x3xf32__size}
    ...
    hal.buffer_view.assert<%arg0 : !hal.buffer_view> message("tensor") shape([%c1, %c3, %c500, %c500_0]) type(%element_type_f32) encoding(%dense_row_major)
    ...
    %5 = stream.async.transfer %4 : !stream.resource<external>{%1} from(#hal.device.affinity<@__device_0>) -> to(#hal.device.affinity<@__device_0>) !stream.resource<*>{%1}
    %6 = stream.tensor.sizeof on(#hal.device.affinity<@__device_0>) tensor<3x500x500xf32> : index
    %7 = stream.tensor.clone on(#hal.device.affinity<@__device_0>) %5 : tensor<1x3x500x500xf32> in !stream.resource<*>{%1} -> tensor<3x500x500xf32> in !stream.resource<*>{%6}
    %8 = stream.tensor.sizeof on(#hal.device.affinity<@__device_0>) tensor<8x498x498xf32> : index
    %9 = stream.tensor.dispatch on(#hal.device.affinity<@__device_0>) @SingleConv$async_dispatch_0::@SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32(%7, %0) : (tensor<3x500x500xf32> in !stream.resource<*>{%6}, tensor<8x3x3x3xf32> in !stream.resource<*>{%__constant_tensor_8x3x3x3xf32__size}) -> tensor<8x498x498xf32> in !stream.resource<*>{%8}
    %10 = stream.tensor.sizeof on(#hal.device.affinity<@__device_0>) tensor<1x8x498x498xf32> : index
    %11 = stream.tensor.clone on(#hal.device.affinity<@__device_0>) %9 : tensor<8x498x498xf32> in !stream.resource<*>{%8} -> tensor<1x8x498x498xf32> in !stream.resource<*>{%10}
    %result, %result_timepoint = stream.timepoint.barrier on(#hal.device.affinity<@__device_0>) %11 : !stream.resource<*>{%10} => !stream.timepoint
    stream.timepoint.chain_external on(#hal.device.affinity<@__device_0>) %result_timepoint => (%arg2 : !hal.fence)
    %12 = stream.async.transfer %result : !stream.resource<*>{%10} from(#hal.device.affinity<@__device_0>) -> to(#hal.device.affinity<@__device_0>) !stream.resource<external>{%10}
    %13 = stream.tensor.export on(#hal.device.affinity<@__device_0>) %12 : tensor<1x8x498x498xf32> in !stream.resource<external>{%10} -> !hal.buffer_view
