...
module {
  ...
  util.initializer {
    ...
    util.global.store %1, @__device_0_executable_0_SingleConv$async_dispatch_0 : !hal.executable
    util.return
  }
  ...
  ^bb1:  // pred: ^bb0
    %memory_type_0 = hal.memory_type<"DeviceVisible|DeviceLocal"> : i32
    %buffer_usage_1 = hal.buffer_usage<"TransferSource|TransferTarget|Transfer|DispatchStorageRead|DispatchStorageWrite|DispatchStorage|SharingImmutable"> : i32
    %buffer = hal.allocator.allocate<%allocator : !hal.allocator> affinity(%c-1_i64) type(%memory_type_0) usage(%buffer_usage_1) : !hal.buffer{%c896}
  ...
  util.func private @__SingleConv$async_memoize_apply(%arg0: !hal.device, %arg1: i64, %arg2: !hal.buffer) -> !hal.command_buffer attributes {inlining_policy = #util.inline.never} {
    ...
    hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%__device_0_executable_0_SingleConv$async_dispatch_0 : !hal.executable)[%c0_0] workgroups([%c6889, %c1, %c1]) bindings([
