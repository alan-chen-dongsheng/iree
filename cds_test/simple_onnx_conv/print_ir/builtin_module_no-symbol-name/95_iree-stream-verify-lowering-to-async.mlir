...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.initializer {
    ...
    %1 = stream.timepoint.await sync %result_timepoint => %results : !stream.resource<constant>{%c864}
    util.global.store %1, @__constant_tensor_8x3x3x3xf32 : !stream.resource<constant>
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %results, %result_timepoint = stream.async.execute on(#hal.device.affinity<@__device_0>) await(%2) => with(%0 as %arg3: !stream.resource<external>{%c3000000}, %__constant_tensor_8x3x3x3xf32 as %arg4: !stream.resource<constant>{%c864}) -> !stream.resource<external>{%c7936128} {
      %4 = stream.async.dispatch @SingleConv$async_dispatch_0::@SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32(%arg3[%c0 to %c3000000 for %c3000000], %arg4[%c0 to %c864 for %c864]) : (!stream.resource<external>{%c3000000}, !stream.resource<constant>{%c864}) -> !stream.resource<external>{%c7936128}
      stream.yield %4 : !stream.resource<external>{%c7936128}
    } => !stream.timepoint
    stream.timepoint.chain_external on(#hal.device.affinity<@__device_0>) %result_timepoint => (%arg2 : !hal.fence)
    %3 = stream.tensor.export on(#hal.device.affinity<@__device_0>) %results : tensor<1x8x498x498xf32> in !stream.resource<external>{%c7936128} -> !hal.buffer_view
