...
module attributes {vm.toplevel} {
  vm.module public @module {
    ...
    ^bb8:  // pred: ^bb7
      ...
      %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_11 = vm.const.ref.rodata @_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83 : !vm.buffer
      %ref_12 = vm.call @hal.executable.create(%4, %c-1_2, %_utf8_embedded_elf_x86_64_FF16E34B4A5F9C83_11, %SingleConv_async_dispatch_0_embedded_elf_x86_64, %null) {nosideeffects} : (!vm.ref<!hal.device>, i64, !vm.buffer, !vm.buffer, !vm.buffer) -> !vm.ref<!hal.executable>
      %__device_0 = vm.global.load.ref immutable @__device_0 : !vm.ref<!hal.device>
      %_const = vm.const.ref.rodata @_const : !vm.buffer
      %ref_13 = vm.call @hal.device.allocator(%__device_0) {nosideeffects} : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
      %ref_14 = vm.call @hal.allocator.import(%ref_13, %c1, %c-1_2, %c48, %c527363, %_const, %zero, %c896) : (!vm.ref<!hal.allocator>, i32, i64, i32, i32, !vm.buffer, i64, i64) -> !vm.ref<!hal.buffer>
      %rnz_15 = vm.cmp.nz.ref %ref_14 : !vm.ref<!hal.buffer>
      vm.global.store.ref %ref_12, @__device_0_executable_0_SingleConv$async_dispatch_0 : !vm.ref<!hal.executable>
      vm.cond_br %rnz_15, ^bb11(%null_0, %ref_14 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>), ^bb10
    ^bb9:  // pred: ^bb7
    ...
    ^bb10:  // pred: ^bb8
      %ref_16 = vm.call @hal.allocator.allocate(%ref_13, %c-1_2, %c48, %c527363, %c896) : (!vm.ref<!hal.allocator>, i64, i32, i32, i64) -> !vm.ref<!hal.buffer>
      %ref_17 = vm.call @hal.ex.file.from_memory(%__device_0, %c-1_2, %c1, %_const, %zero, %c896, %zero_1) : (!vm.ref<!hal.device>, i64, i32, !vm.buffer, i64, i64, i32) -> !vm.ref<!hal.file>
      %ref_18 = vm.call @hal.fence.create(%__device_0, %zero) : (!vm.ref<!hal.device>, i64) -> !vm.ref<!hal.fence>
      vm.call @hal.device.queue.read(%__device_0, %c-1_2, %null_0, %ref_18, %ref_17, %zero, %ref_16, %zero, %c896, %zero) : (!vm.ref<!hal.device>, i64, !vm.ref<!hal.fence>, !vm.ref<!hal.fence>, !vm.ref<!hal.file>, i64, !vm.ref<!hal.buffer>, i64, i64, i64) -> ()
      vm.br ^bb11(%ref_18, %ref_16 : !vm.ref<!hal.fence>, !vm.ref<!hal.buffer>)
