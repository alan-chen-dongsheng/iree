...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.global private @__constant_tensor_8x3x3x3xf32__timepoint = #stream.timepoint<immediate> : !stream.timepoint
  ...
  util.initializer {
    ...
    %results, %result_timepoint = stream.resource.constants on(#hal.device.affinity<@__device_0>) : 
      !stream.resource<constant>{%c864} = dense<""> : tensor<8x3x3x3xf32>
      => !stream.timepoint
    %1 = stream.cmd.execute once on(#hal.device.affinity<@__device_0>) with() {
    } => !stream.timepoint
    %2 = stream.timepoint.join max(%result_timepoint, %1) => !stream.timepoint
    %3 = stream.timepoint.await sync %2 => %results : !stream.resource<constant>{%c864}
    util.global.store %3, @__constant_tensor_8x3x3x3xf32 : !stream.resource<constant>
  ...
  util.func public @SingleConv$async(%arg0: !hal.buffer_view, %arg1: !hal.fence, %arg2: !hal.fence) -> !hal.buffer_view attributes {inlining_policy = #util.inline.never, iree.abi.model = "coarse-fences", iree.abi.stub} {
    ...
    %c0 = arith.constant 0 : index
    %__constant_tensor_8x3x3x3xf32__timepoint = util.global.load immutable @__constant_tensor_8x3x3x3xf32__timepoint : !stream.timepoint
    ...
    %2 = stream.timepoint.join max(%1, %__constant_tensor_8x3x3x3xf32__timepoint) => !stream.timepoint
    %c0_0 = arith.constant 0 : index
    %result, %result_timepoint = stream.resource.alloca uninitialized on(#hal.device.affinity<@__device_0>) await(%2) => !stream.resource<external>{%c7936128} => !stream.timepoint
    %3 = stream.timepoint.join max(%2, %result_timepoint) => !stream.timepoint
    %4 = stream.cmd.execute on(#hal.device.affinity<@__device_0>) await(%3) => with(%0 as %arg3: !stream.resource<external>{%c3000000}, %__constant_tensor_8x3x3x3xf32 as %arg4: !stream.resource<constant>{%c864}, %result as %arg5: !stream.resource<external>{%c7936128}) {
      stream.cmd.dispatch @SingleConv$async_dispatch_0::@SingleConv$async_dispatch_0_conv_8x498x498x3x3x3_f32 {
        ...
        ro %arg4[%c0 for %c864] : !stream.resource<constant>{%c864},
        wo %arg5[%c0_0 for %c7936128] : !stream.resource<external>{%c7936128}
      }
    } => !stream.timepoint
    stream.timepoint.chain_external on(#hal.device.affinity<@__device_0>) %4 => (%arg2 : !hal.fence)
    %5 = stream.tensor.export on(#hal.device.affinity<@__device_0>) %result : tensor<1x8x498x498xf32> in !stream.resource<external>{%c7936128} -> !hal.buffer_view
